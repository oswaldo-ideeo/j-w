				...
				<div class="color-white2">
					<div class="row">
						...
						<div class="row">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-6 cards-upgrade">
										<div class="col-md-1"><img src="images/visa.png"></div>
										<div class="col-md-1"><img src="images/mastercard.png"></div>
										<div class="col-md-1"><img src="images/american.png"></div>
										<div class="col-md-1"><img src="images/bva.png"></div>
									</div>
								</div>
							</div>
							...
							<div class="container">
								<div class="row">
									<div class="col-md-9 col-xs-12  cards-upgrade-second">
										<div class="col-md-1"><input class="input-card" type="text" placeholder="MM" name=""></div>
										<div class="col-md-1"><input class="input-card" type="text" placeholder="YY" name=""></div>
										<div class="col-md-1"><p class="text-cvv"><b>CVV</b></p></div>
										<div class="col-md-1"><input class="input-card" type="text" placeholder="MM" name=""></div>
										<div class="col-md-1"><img src="images/question.png"></div>
									</div>
								</div>
